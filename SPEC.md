...
## コア機能
emoji-picker,daily-prompt,weekly-summary,parent-share,calendar-view
...
- npm run lint 通過
- npm run build 通過
- release/emotion-checkin.zip 生成
...
- 名前 (ja): きもち記録
- 名前 (en): 
- 概要 (132字以内, ja): 1日数回の絵文字感情記録 + 週次保護者通知
- カテゴリ: ライフスタイル
- 言語: 日本語, English
- プライバシーポリシー URL: https://github.com/tabisurushosai/emotion-checkin/blob/main/legal/PRIVACY.md
